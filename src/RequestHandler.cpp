...
void v3d::dx::RequestHandler::handleOpenProjectRequested(std::string projFileName, int clientId)
{

}

void v3d::dx::RequestHandler::handleCloseProjectRequested(int clientId)
{

}

void v3d::dx::RequestHandler::handleGetSceneRequested(int64_t id, int clientId)
{

}

void v3d::dx::RequestHandler::handleFrameRequested(const v3d::JsonValue& scene, int clientId)
{
